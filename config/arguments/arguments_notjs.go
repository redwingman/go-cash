...
Options:
  ...
  --tcp-proxy-bypass-localhost                       Disable proxy for "localhost" and "127.0.0.1".
  ...
  --blocks-sync=BLOCKS                               Number of blocks to download in a batch.
`
